...
export const LANGUAGES = [
  { id: 'en', name: 'English', share: 34 },
  { id: 'hi', name: 'Hindi', share: 15 },
  { id: 'kn', name: 'Kannada', share: 14 },
  { id: 'hinglish', name: 'Hinglish (code-mixed)', share: 14 },
  { id: 'kn-en', name: 'Kannada-English', share: 9 },
  { id: 'ta', name: 'Tamil', share: 5 },
  { id: 'te', name: 'Telugu', share: 4 },
  { id: 'mr', name: 'Marathi', share: 3 },
  { id: 'bn', name: 'Bengali', share: 2 },
]
...
export const ACCOUNTS = [
  ...
  { id: 'a16', handle: '@bescom_alerts', name: 'BESCOM Alerts', followers: 288000, engagement: 4.2, centrality: 0.71, relevance: 0.91, amplification: 1.2, persona: 'supporter', community: 'c6', verified: true },
  { id: 'a17', handle: '@health_dept_blr', name: 'District Health Office', followers: 164000, engagement: 3.6, centrality: 0.68, relevance: 0.89, amplification: 1.1, persona: 'supporter', community: 'c6', verified: true },
  { id: 'a18', handle: '@weather_kar', name: 'Karnataka Weather', followers: 540000, engagement: 7.8, centrality: 0.79, relevance: 0.94, amplification: 2.1, persona: 'starter', community: 'c6', verified: true },
  { id: 'a19', handle: '@kannada_first', name: 'Kannada First', followers: 372000, engagement: 11.4, centrality: 0.74, relevance: 0.81, amplification: 3.3, persona: 'critic', community: 'c7', verified: false },
  { id: 'a20', handle: '@south_voice', name: 'South Voice', followers: 918000, engagement: 5.2, centrality: 0.67, relevance: 0.63, amplification: 2.6, persona: 'critic', community: 'c7', verified: true },
  { id: 'a21', handle: '@campus_hire_in', name: 'Campus Hire India', followers: 128000, engagement: 9.1, centrality: 0.59, relevance: 0.87, amplification: 1.8, persona: 'seeker', community: 'c4', verified: false },
  { id: 'a22', handle: '@coastal_watch', name: 'Coastal Watch', followers: 84000, engagement: 8.6, centrality: 0.61, relevance: 0.92, amplification: 1.6, persona: 'starter', community: 'c6', verified: false },
  { id: 'a23', handle: '@dr_anitha_pub', name: 'Dr. Anitha (public health)', followers: 96000, engagement: 10.3, centrality: 0.63, relevance: 0.9, amplification: 1.4, persona: 'seeker', community: 'c3', verified: true },
  { id: 'a24', handle: '@rumor_mill_24x7', name: 'Rumor Mill 24x7', followers: 31000, engagement: 0.7, centrality: 0.24, relevance: 0.33, amplification: 5.9, persona: 'amplifier', community: 'c5', verified: false, suspicious: true },
]

export const COMMUNITIES = [
  { id: 'c1', label: 'Civic / mobility core', color: '#6ea8ff', size: 0.26 },
  { id: 'c2', label: 'Mainstream media', color: '#2fd4a7', size: 0.15 },
  { id: 'c3', label: 'Tech worker cluster', color: '#c77dff', size: 0.18 },
  { id: 'c4', label: 'Student & commuter', color: '#ffb02e', size: 0.13 },
  { id: 'c5', label: 'Low-quality amplifier ring', color: '#ff5d73', size: 0.07 },
  { id: 'c6', label: 'Official / civic agencies', color: '#5be7c4', size: 0.12 },
  { id: 'c7', label: 'Language & identity cluster', color: '#ff8a5b', size: 0.09 },
]
...
export const EDGES = [
  ...
  ['a18', 'a22', 9], ['a18', 'a9', 6], ['a18', 'a1', 5], ['a18', 'a3', 4], ['a22', 'a3', 4],
  ['a19', 'a20', 9], ['a19', 'a10', 5], ['a19', 'a8', 4], ['a20', 'a2', 6], ['a20', 'a9', 5],
  ['a21', 'a10', 8], ['a21', 'a6', 5], ['a21', 'a4', 4],
  ['a24', 'a12', 9], ['a24', 'a13', 9], ['a24', 'a8', 7], ['a24', 'a19', 3],
]
...
export const TOPICS = [
  ...
  },
  {
    id: 'lang',
    tag: '#LanguagePolicy',
    title: 'Three-language formula in schools',
    category: 'Policy',
    mentions: 38900,
    growth: 112,
    velocity: 81,
    sentiment: { pos: 21, neu: 22, neg: 57 },
    sentimentShift: -24,
    emotions: { anger: 71, fear: 26, joy: 11, sadness: 18, surprise: 29, disgust: 44, trust: 14, anticipation: 33 },
    stance: { support: 26, oppose: 52, neutral: 12, unclear: 10 },
    sarcasm: 46,
    virality: 79,
    peakEtaMin: 265,
    predictedMentions: 61200,
    predictedNeg: 61,
    crisis: 61,
    misinfo: 53,
    coordination: 44,
    platforms: { x: 17800, reddit: 5200, youtube: 9100, instagram: 5900, news: 900 },
    propagation: [
      { from: 'news', to: 'x', delayMin: 18, volume: 9400, sentimentDelta: -17 },
      { from: 'x', to: 'youtube', delayMin: 24, volume: 6100, sentimentDelta: -8 },
      { from: 'x', to: 'instagram', delayMin: 33, volume: 4200, sentimentDelta: -6 },
      { from: 'youtube', to: 'reddit', delayMin: 57, volume: 2400, sentimentDelta: 5 },
    ],
    geo: [
      { place: 'Bengaluru', neg: 61, mentions: 14200 },
      { place: 'Mysuru', neg: 66, mentions: 6100 },
      { place: 'Hubballi', neg: 63, mentions: 5400 },
      { place: 'Belagavi', neg: 58, mentions: 4900 },
      { place: 'Mangaluru', neg: 54, mentions: 4300 },
      { place: 'Chennai', neg: 49, mentions: 4000 },
    ],
    influencers: ['a19', 'a20', 'a2', 'a10', 'a9'],
    drivers: [
      { at: '08:15', kind: 'seed', text: 'Draft circular on the three-language formula leaks', weight: 29 },
      { at: '09:40', kind: 'amplify', text: '@kannada_first thread crosses 88k engagements in an hour', weight: 26 },
      { at: '11:05', kind: 'sentiment', text: 'Stance polarises: neutral share collapses from 31% to 12%', weight: 21 },
      { at: '13:22', kind: 'merge', text: 'Merges with an older #MotherTongue campaign', weight: 14 },
      { at: '15:48', kind: 'migration', text: 'Long-form rebuttals move the argument onto YouTube', weight: 10 },
    ],
    misinfoFactors: [
      { label: 'Circular quoted without its exemption clause', weight: 36 },
      { label: 'Fabricated quote attributed to an official', weight: 31 },
      { label: 'Coordinated hashtag pairing across 2 clusters', weight: 24 },
      { label: 'Old 2019 protest footage recirculating', weight: 19 },
    ],
    actions: [
      { p: 'high', text: 'Release the full circular text with the exemption clause', why: 'The omitted clause drives 36% of misinformation risk' },
      { p: 'high', text: 'Deny or confirm the attributed quote within the hour', why: 'A fabricated quote is spreading faster than the circular itself' },
      { p: 'medium', text: 'Brief regional-language desks directly', why: 'Kannada and Kannada-English carry 41% of this conversation' },
      { p: 'low', text: 'Track the two hashtag clusters for coordination', why: 'Coordination score 44 with paired-tag behaviour' },
    ],
  },
  {
    id: 'power',
    ...
    growth: 96,
    velocity: 68,
    sentiment: { pos: 8, neu: 24, neg: 68 },
    sentimentShift: -19,
    emotions: { anger: 68, fear: 24, joy: 3, sadness: 27, surprise: 22, disgust: 41, trust: 12, anticipation: 21 },
    stance: { support: 9, oppose: 66, neutral: 18, unclear: 7 },
    sarcasm: 34,
    virality: 58,
    peakEtaMin: 190,
    predictedMentions: 29800,
    predictedNeg: 71,
    crisis: 54,
    misinfo: 22,
    coordination: 9,
    platforms: { x: 9200, reddit: 3600, youtube: 3100, instagram: 4700, news: 800 },
    propagation: [
      { from: 'x', to: 'instagram', delayMin: 21, volume: 4300, sentimentDelta: -9 },
      { from: 'instagram', to: 'youtube', delayMin: 38, volume: 2600, sentimentDelta: -5 },
      { from: 'x', to: 'news', delayMin: 64, volume: 800, sentimentDelta: 6 },
    ],
    geo: [
      { place: 'Bengaluru', neg: 71, mentions: 9800 },
      { place: 'Tumakuru', neg: 58, mentions: 3100 },
      { place: 'Hubballi', neg: 52, mentions: 2900 },
      { place: 'Davanagere', neg: 49, mentions: 2800 },
      { place: 'Mysuru', neg: 44, mentions: 2800 },
    ],
    influencers: ['a16', 'a1', 'a3', 'a9'],
    drivers: [
      { at: '13:30', kind: 'seed', text: 'Outage reports cluster across four substations', weight: 32 },
      { at: '14:12', kind: 'sentiment', text: 'Sarcastic complaint format spreads, 34% flagged ironic', weight: 24 },
      { at: '15:40', kind: 'amplify', text: 'Reels of dark streets cross 120k views', weight: 23 },
      { at: '17:05', kind: 'migration', text: 'Conversation moves from X onto Instagram', weight: 21 },
    ],
    misinfoFactors: [
      { label: 'Unverified claim of a week-long schedule', weight: 29 },
      { label: 'Outage map from a different state in circulation', weight: 24 },
    ],
    actions: [
      { p: 'high', text: 'Publish substation-wise restoration times', why: 'Absence of a schedule is what the sarcasm is attaching to' },
      { p: 'medium', text: 'Push updates through @bescom_alerts hourly', why: 'It is the highest-relevance account and already trusted here' },
      { p: 'low', text: 'Correct the out-of-state outage map', why: 'Low reach so far, but it is the second misinformation driver' },
    ],
  },
  {
    id: 'flood',
    tag: '#CoastalAlert',
    title: 'Yellow alert for coastal districts',
    category: 'Disaster response',
    mentions: 16800,
    growth: 241,
    velocity: 88,
    sentiment: { pos: 14, neu: 41, neg: 45 },
    sentimentShift: -13,
    emotions: { anger: 18, fear: 79, joy: 4, sadness: 36, surprise: 52, disgust: 8, trust: 44, anticipation: 61 },
    stance: { support: 38, oppose: 14, neutral: 39, unclear: 9 },
    sarcasm: 8,
    virality: 82,
    peakEtaMin: 95,
    predictedMentions: 34600,
    predictedNeg: 48,
    crisis: 74,
    misinfo: 58,
    coordination: 12,
    platforms: { x: 6900, reddit: 1800, youtube: 3400, instagram: 3900, news: 800 },
    propagation: [
      { from: 'news', to: 'x', delayMin: 9, volume: 4100, sentimentDelta: -7 },
      { from: 'x', to: 'instagram', delayMin: 14, volume: 3200, sentimentDelta: -5 },
      { from: 'x', to: 'youtube', delayMin: 26, volume: 2400, sentimentDelta: -3 },
      { from: 'instagram', to: 'reddit', delayMin: 48, volume: 1100, sentimentDelta: 4 },
    ],
    geo: [
      { place: 'Mangaluru', neg: 47, mentions: 5400 },
      { place: 'Udupi', neg: 44, mentions: 3900 },
      { place: 'Karwar', neg: 41, mentions: 2600 },
      { place: 'Shivamogga', neg: 33, mentions: 2100 },
      { place: 'Bengaluru', neg: 28, mentions: 2800 },
    ],
    influencers: ['a18', 'a22', 'a9', 'a3'],
    drivers: [
      { at: '06:02', kind: 'seed', text: 'Met department issues a yellow alert for three districts', weight: 34 },
      { at: '06:24', kind: 'amplify', text: '@weather_kar map is reposted 4.1k times in 20 minutes', weight: 27 },
      { at: '07:10', kind: 'sentiment', text: 'Fear reaches 79 while trust holds at 44', weight: 22 },
      { at: '08:35', kind: 'migration', text: 'Ground footage from Udupi crosses onto Instagram', weight: 17 },
    ],
    misinfoFactors: [
      { label: 'Red-alert claim when the alert is yellow', weight: 39 },
      { label: 'Footage from the 2024 monsoon presented as today', weight: 32 },
      { label: 'Unofficial school-closure list circulating', weight: 27 },
    ],
    actions: [
      { p: 'critical', text: 'Restate the alert level in KN and EN on every channel', why: 'A red-alert claim is the single largest misinformation driver at 39%' },
      { p: 'critical', text: 'Confirm or deny the school-closure list within 30 minutes', why: 'Parents are acting on an unofficial list right now' },
      { p: 'high', text: 'Amplify through @weather_kar and @coastal_watch', why: 'Highest topic relevance and already carrying the accurate map' },
      { p: 'medium', text: 'Reverse-image the circulating footage', why: 'Reused 2024 monsoon video is inflating perceived severity' },
    ],
  },
  {
    id: 'health',
    tag: '#DengueWatch',
    title: 'Dengue case spike in three wards',
    category: 'Public health',
    mentions: 12300,
    growth: 87,
    velocity: 63,
    sentiment: { pos: 16, neu: 38, neg: 46 },
    sentimentShift: -15,
    emotions: { anger: 24, fear: 66, joy: 5, sadness: 41, surprise: 33, disgust: 21, trust: 38, anticipation: 44 },
    stance: { support: 41, oppose: 22, neutral: 28, unclear: 9 },
    sarcasm: 12,
    virality: 49,
    peakEtaMin: 420,
    predictedMentions: 17900,
    predictedNeg: 49,
    crisis: 46,
    misinfo: 64,
    coordination: 27,
    platforms: { x: 4600, reddit: 1900, youtube: 2600, instagram: 2700, news: 500 },
    propagation: [
      { from: 'news', to: 'x', delayMin: 26, volume: 2900, sentimentDelta: -8 },
      { from: 'x', to: 'instagram', delayMin: 41, volume: 2100, sentimentDelta: -4 },
      { from: 'instagram', to: 'youtube', delayMin: 72, volume: 1400, sentimentDelta: -2 },
    ],
    geo: [
      { place: 'Bengaluru', neg: 52, mentions: 6800 },
      { place: 'Mysuru', neg: 38, mentions: 1900 },
      { place: 'Tumakuru', neg: 35, mentions: 1800 },
      { place: 'Mandya', neg: 31, mentions: 1800 },
    ],
    influencers: ['a17', 'a23', 'a15', 'a3'],
    drivers: [
      { at: '10:40', kind: 'seed', text: 'Ward-level case counts published in the weekly bulletin', weight: 28 },
      { at: '12:15', kind: 'amplify', text: 'A home-remedy claim outruns the bulletin 6 to 1', weight: 33 },
      { at: '14:50', kind: 'sentiment', text: 'Fear climbs to 66 while anger stays low at 24', weight: 22 },
      { at: '16:30', kind: 'merge', text: 'Merges with a ward sanitation complaint thread', weight: 17 },
    ],
    misinfoFactors: [
      { label: 'Unproven home remedy presented as a cure', weight: 43 },
      { label: 'Case numbers inflated 5x in reposts', weight: 34 },
      { label: 'Claim that a vaccine is being withheld', weight: 26 },
      { label: 'Low-credibility health sites as primary source', weight: 21 },
    ],
    actions: [
      { p: 'critical', text: 'Counter the home-remedy claim with a clinician on record', why: 'It is outrunning the official bulletin 6 to 1 and is a health risk' },
      { p: 'high', text: 'Republish verified ward-level counts as a graphic', why: 'Numbers are being inflated 5x in reposts; a shareable format competes' },
      { p: 'medium', text: 'Route @dr_anitha_pub into the reply threads', why: 'Highest engagement among trusted health voices in this cluster' },
    ],
  },
]
...
export const POSTS = [
  ...
  { topic: 'lang', platform: 'x', author: '@kannada_first', lang: 'Kannada', text: 'Namma makkalige namma bhasheyalli kalitha kodi. Ashte kelodu.', sentiment: 'neg', surface: 'neu', sarcasm: 11, emotion: 'anger', stance: 'oppose', place: 'Bengaluru', bot: 3 },
  { topic: 'lang', platform: 'x', author: '@policy_watch', lang: 'English', text: 'The draft has an opt-out clause on page 7. Almost nobody quoting it has read that far.', sentiment: 'neu', surface: 'neu', sarcasm: 9, emotion: 'trust', stance: 'neutral', place: 'Delhi NCR', bot: 1 },
  { topic: 'lang', platform: 'youtube', author: '@south_voice', lang: 'Tamil', text: 'Moondru mozhi thittam patthi ellarum pesuraanga, aana yaarum full ah padikkala', sentiment: 'neg', surface: 'neg', sarcasm: 18, emotion: 'disgust', stance: 'oppose', place: 'Chennai', bot: 2 },
  { topic: 'lang', platform: 'instagram', author: '@blr_daily', lang: 'Hinglish', text: 'Kya baat hai, ek aur policy bina consultation ke. Kitna accha lag raha hai.', sentiment: 'neg', surface: 'pos', sarcasm: 92, emotion: 'disgust', stance: 'oppose', place: 'Bengaluru', bot: 5 },
  { topic: 'power', platform: 'x', author: '@bescom_alerts', lang: 'English', text: 'Feeder fault at 3 substations. Restoration expected by 21:30. Ward list in thread.', sentiment: 'neu', surface: 'neu', sarcasm: 1, emotion: 'trust', stance: 'neutral', place: 'Bengaluru', bot: 1 },
  { topic: 'power', platform: 'instagram', author: '@city_pulse', lang: 'Kannada-English', text: 'Current hogide 4 hours inda, inverter battery kuda mugidide', sentiment: 'neg', surface: 'neg', sarcasm: 7, emotion: 'anger', stance: 'oppose', place: 'Tumakuru', bot: 4 },
  { topic: 'power', platform: 'x', author: '@techie_rants', lang: 'Hinglish', text: 'Perfect timing. Demo se 10 minute pehle light gayi. Shukriya.', sentiment: 'neg', surface: 'pos', sarcasm: 90, emotion: 'disgust', stance: 'oppose', place: 'Bengaluru', bot: 2 },
  { topic: 'flood', platform: 'x', author: '@weather_kar', lang: 'English', text: 'YELLOW alert for Dakshina Kannada, Udupi and Uttara Kannada. Not red. Please share the correct level.', sentiment: 'neu', surface: 'neu', sarcasm: 1, emotion: 'trust', stance: 'neutral', place: 'Mangaluru', bot: 1 },
  { topic: 'flood', platform: 'instagram', author: '@coastal_watch', lang: 'Kannada-English', text: 'Udupi alli neeru tumba ide beedili, drive madbedi please', sentiment: 'neg', surface: 'neg', sarcasm: 3, emotion: 'fear', stance: 'support', place: 'Udupi', bot: 2 },
  { topic: 'flood', platform: 'x', author: '@rumor_mill_24x7', lang: 'English', text: 'RED ALERT declared, all schools shut for 3 days. Forward to everyone!', sentiment: 'neg', surface: 'neg', sarcasm: 2, emotion: 'fear', stance: 'oppose', place: 'Unknown', bot: 94 },
  { topic: 'health', platform: 'x', author: '@dr_anitha_pub', lang: 'English', text: 'Papaya leaf extract is not a dengue cure. Platelet counts need clinical monitoring, not kitchen remedies.', sentiment: 'neu', surface: 'neu', sarcasm: 2, emotion: 'trust', stance: 'neutral', place: 'Bengaluru', bot: 1 },
  { topic: 'health', platform: 'instagram', author: '@daily_forward_99', lang: 'Hinglish', text: 'Dengue ka ilaaj mil gaya! Ye patta ubaal kar piyo, 2 din me theek. Forward karo', sentiment: 'pos', surface: 'pos', sarcasm: 3, emotion: 'joy', stance: 'support', place: 'Unknown', bot: 91 },
  { topic: 'health', platform: 'x', author: '@ward_watch', lang: 'Kannada', text: 'Namma wardnalli fogging aagilla ondu tingalinda. Dengue jaasti aagtide.', sentiment: 'neg', surface: 'neg', sarcasm: 5, emotion: 'fear', stance: 'oppose', place: 'Bengaluru', bot: 3 },
]
...
export const STREAM_TEMPLATES = [
  ...
  { lang: 'Tamil', text: '{t} vishayathula onnume nadakala, ellame pesi mudinjiruchu', s: 'neg', e: 'disgust', sar: 14 },
  { lang: 'Telugu', text: '{t} gurinchi official ga emaina cheppara?', s: 'neu', e: 'anticipation', sar: 4 },
  { lang: 'Marathi', text: '{t} baddal kaahi mahiti aahe ka? Roj haach prashna aahe', s: 'neu', e: 'fear', sar: 5 },
  { lang: 'Bengali', text: '{t} niye ekhono kono update nei, ki obostha', s: 'neg', e: 'sadness', sar: 8 },
  { lang: 'Kannada-English', text: 'Officials {t} bagge alert kotidare, at least this time timely', s: 'pos', e: 'trust', sar: 6 },
...
export const HANDLES = [
  ...
  '@bescom_alerts', '@weather_kar', '@coastal_watch', '@kannada_first', '@south_voice',
  '@campus_hire_in', '@dr_anitha_pub', '@rumor_mill_24x7', '@health_dept_blr',
]
...
export const PLACES = [
  'Bengaluru', 'Mysuru', 'Hubballi', 'Mangaluru', 'Udupi', 'Belagavi', 'Tumakuru',
  'Davanagere', 'Delhi NCR', 'Hyderabad', 'Chennai', 'Unknown',
]
